@extends('layouts.app')
    ...
    <section class="dashboard-section">
        <div class="container">
            <div class="shadow-sm rounded bg-white my-2">
                <div class="p-3">
                    <form action="/search" method="get">
                        <div class="input-group shadow-sm rounded bg-green">
                            <input class="form-control rounded-left border-0 bg-ash" type="text" name="search" placeholder="Search...">
                            <button type="submit" class="btn bg-" ><i class="fa fa-search fa-lg text-white"></i></button>
                        </div>
                    </form> 
                </div>
            </div>
            ...
            <div id="auto" class="row justify-content-center">
                <div class="col-12">
                    @if(count($forum) > 0)
