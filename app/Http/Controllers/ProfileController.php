...
class ProfileController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('user_image') && $user->user_image !== 'noimage.jpeg'){
            Storage::delete('public/user_images/'.$user->user_image);
        }
        
        if($request->hasFile('user_image')){
            $file_with_ext = $request->user_image->getClientOriginalName();
            ...
            $request->user_image->storeAs('public/user_images/',$file);
